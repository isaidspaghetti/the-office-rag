...
def render_structure_page() -> None:
    ...
    p1 = Path(REPO_ROOT) / "apps" / "dashboard" / "assets" / "system_arch.jpg"
    p2 = Path(REPO_ROOT) / "apps" / "dashboard" / "assets" / "logos.jpg"

    if p1.exists():
        _st_image(str(p1))
    else:
        st.info("Missing image: apps/dashboard/assets/system_arch.jpg")
    ...
    if p2.exists():
        ...
        st.info("Missing image: apps/dashboard/assets/logos.jpg")
